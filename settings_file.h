...
static const int TW_SAVE_REBOOT_SETTING = 13;

static const char tw_version_val[] = "1.0.4"; // Variable Holding Version
...
char tw_save_reboot_setting_option[TW_MIN_SETTINGS_CHARS];
